...
id: 2186
islctt: true
largepic: https://img.linux.net.cn/data/attachment/album/201310/29/165842or7h57io03rp577f.jpg
url: /article-2186-1.html
pic: https://img.linux.net.cn/data/attachment/album/201310/29/165842or7h57io03rp577f.jpg.thumb.jpg
related: []
reviewer: ''
selector: ''
...
Ubuntu 13.10 已经发布了，对于那些打算安装“纯净版”的用户，安装完系统后你可以考虑下面的8件事。
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165842or7h57io03rp577f.jpg)


### **1. 安装一些绚丽的小零件**


![](https://img.linux.net.cn/data/attachment/album/201310/29/165845rthht45jb2yh240y.png) 


**系统负载** 是系统监控工具GNOME里的一个小应用。它能在面板上展示出CPU、内存、网络使用、硬盘I/O等信息。点击下面的按钮从Ubuntu软件中心安装。


 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://indicator-multiload)
...
![](https://img.linux.net.cn/data/attachment/album/201310/29/165847z9oq7l59iz49xlom.png) 


**CPU频率**是一款等效于“GNOME-CPU调频”的应用。你可以实时的调整CPU的频率。点击下面的按钮从Ubuntu软件中心安装。


[![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://indicator-cpufreq) 
...
sudo apt-get install my-weather-indicator
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201404/09/133303ado8z54j4dmj3sjr.jpg)
...
sudo apt-get install variety
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165849jra92y9m2g2rzzxl.png)


你可能还需要一个剪切板管理器，试试**Diodon** 吧，这是款轻量型软件，支持文件、图像等。点击下面的按钮安装：


[![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://diodon,diodon-plugins) 
...
### **2. 设置 Unity**
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165852iaifp729k1kickf5.png)
...
点击下面的按钮从软件中心安装
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://unity-tweak-tool)
...
### **3. 隐私设置**
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165854pgkjb66ur6cclcl2.png)
...
更多插件屏蔽，点击[此处](http://www.webupd8.org/2013/10/how-to-disable-amazon-shopping.html)
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165857fi0ajwf7ahabagyy.png)
...
![](https://img.linux.net.cn/data/attachment/album/201310/29/1659003pm5ko67pw7h7hpk.png) 
...
点击下面的按钮安装laptop-mode-tools。
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://laptop-mode-tools)
...
点击下面的按钮进行安装：
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://bumblebee,bumblebee-nvidia)
...
如果需要播放更多类型的音频视频文件，那就安装 **Ubuntu Restricted Extras** 吧
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://ubuntu-restricted-extras)
...
[![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://libavformat-extra-53,libavcodec-extra-53) 
...
你可能需要Java，但是你得明确你到底需要的是什么，不少用户仅仅使用**OpenJRE**和java游览器插件，你可以点击下面的按钮安装：
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://icedtea-7-plugin,openjdk-7-jre)
...
如果用于开发，你可能需要**OpenJDK**，点击下面的按钮进行安装:
 ...
 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://openjdk-7-jdk)
...
### **7. 安装最新的 Rhythmbox 和 VLC**
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165904gg3nda3dkakzh3l0.png)
...
### **8. Tweak Nautilus: 打开被禁用的递归搜索和文件快速预览**
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165907nq61iwnt6tsql94l.png)
...
gsettings set org.gnome.nautilus.preferences enable-recursive-search true
 ...
 ![](https://img.linux.net.cn/data/attachment/album/201310/29/165910v6267v3xf577q6tx.png)


**GNOME Sushi**是一款快速预览的软件。点击下面的按钮安装。（会安装gnome-sushi 和 unoconv来实现预览）。


 [![](https://img.linux.net.cn/data/attachment/album/201310/29/164151d4a26sm2zqusvbq4.png)](apt://gnome-sushi,unoconv)
