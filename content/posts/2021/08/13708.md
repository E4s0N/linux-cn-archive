...
id: 13708
islctt: true
largepic: https://img.linux.net.cn/data/attachment/album/202108/22/090306jlkzyrw8cytcatw8.jpg
url: /article-13708-1.html
pic: https://img.linux.net.cn/data/attachment/album/202108/22/090306jlkzyrw8cytcatw8.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
...
![](https://img.linux.net.cn/data/attachment/album/202108/22/090306jlkzyrw8cytcatw8.jpg "Women programming")
...
![在文本框中输入 “podman”](https://img.linux.net.cn/data/attachment/album/202108/22/090353vvo7p5w8rp0rmuru.png "Enter \"podman\" in the text box")
...
![Remote-Containers: Add Development Container Configuration Files](https://img.linux.net.cn/data/attachment/album/202108/22/090353p6bbnwb4swzutx9k.png "Remote-Containers: Add Development Container Configuration Files")


在接下来的弹出窗口中，定义你想设置的开发环境的类型。对于这个例子的配置，搜索 “Python 3” 定义并选择它。


![选择 Python 3 定义](https://img.linux.net.cn/data/attachment/album/202108/22/090354bzaj4k49jjnxsky1.png "Select Python 3 definition")


接下来，选择将在容器中使用的 Python 的版本。选择 “3 (default)” 选项以使用最新的版本。


![选择 “3 (default)” 选项](https://img.linux.net.cn/data/attachment/album/202108/22/090354tbjpglgf68fffbf8.png "Select the 3 (default) option")


Python 配置也可以安装 Node.js，但在这个例子中，取消勾选 “Install Node.js”，然后点击 “OK”。


![取消勾选 “Install Node.js"](https://img.linux.net.cn/data/attachment/album/202108/22/090354kf3nfbpo9fnnp7nc.png "Uncheck \"Install Node.js\"")
...
![更新后的 devcontainer.json 文件](https://img.linux.net.cn/data/attachment/album/202108/22/090355oy456mfx06kik6zi.png "Updated devcontainer.json file")
...
![构建容器](https://img.linux.net.cn/data/attachment/album/202108/22/090355lt2p1t8jbet14sje.png "Building the container")
